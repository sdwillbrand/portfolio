...
const CurrentStudy = ({ className }: HTMLProps<HTMLDivElement>) => (
  <div
    className={`${className} border-sky-700 border text-center flex flex-col md:flex-row gap-5 md:gp-0 justify-between items-center p-6 bg-gradient-to-b from-transparent to-sky-950`}
  >
